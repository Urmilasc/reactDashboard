      ...
      <div>
        <nav className="navbar navbar-expand-lg" style={{backgroundColor:"#fcdf03"}}>
          <div className="container-fluid">
            ...
            <a className="navbar-brand d-flex ml-auto display-2 text-white fs-2 fw-bold text-uppercase"
                style={{fontFamily:"NHaasGroteskDSPro-65Md", textShadow:"1px 1px #1a1a1a"}} href="/"
            >Crypto Dashboard</a>
          </div>
        </nav>
      </div>
